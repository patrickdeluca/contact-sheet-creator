...
class ContactSheetCreatorGUI(QWidget):
    ...
    def __init__(self):
        ...
        # Set width and height to a larger fixed size or use screen size
        screen_size = QApplication.desktop().availableGeometry()
        self.width = int(screen_size.width() * 0.8)  # 80% of screen width
        self.height = int(screen_size.height() * 0.8)  # 80% of screen height
