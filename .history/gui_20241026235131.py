...
class ContactSheetCreatorGUI(QWidget):
    ...
    def __init__(self):
        ...
        self.available_fonts = self._getAvailableFonts()
    ...
    def _getAvailableFonts(self):
        ...
        return [
            family for family in self.font_db.families() 
    ...
    def initUI(self):
        ...
        default_font = self._getDefaultFont()
        ...
        # Top section with file inputs
        top_widget = QWidget()
        top_widget.setLayout(self.createTopLayout())
        top_widget.setMaximumHeight(50)  # Limit height of top section
        main_layout.addWidget(top_widget)
        
        # Main splitter takes all remaining space
        main_layout.addWidget(self.createMainSplitter(), stretch=1)
    ...
    def initializeFields(self):
        ...
        if settings.font_name in self.available_fonts:
    ...
    def _createFontComboBox(self):
        ...
        fonts_to_add = [f for f in preferred_fonts if f in self.available_fonts]
        # Add remaining system fonts
        fonts_to_add.extend([
            f for f in self.available_fonts 
            if f not in fonts_to_add
        ])
        ...
        if fonts_to_add:
            self.font_combo_box.setCurrentText(fonts_to_add[0])
