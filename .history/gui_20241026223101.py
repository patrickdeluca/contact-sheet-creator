...
class ContactSheetCreatorGUI(QWidget):
    ...
    def initializeFields(self):
        ...
        self.filename_pattern_line_edit.setText(settings.filename_pattern)
    ...
    def _rotateImages(self, angle):
        ...
        for item in selected_items:
            ...
            self.image_processor.rotateImage(info, angle)
        self.loadImages()
    ...
    def updatePreview(self):
        ...
        preview_image = self.image_processor.generatePreview(selected_images)
        if preview_image:
    ...
    def createContactSheet(self):
        ...
        if self.image_processor.createContactSheet(selected_images):
