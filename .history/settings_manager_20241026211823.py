...
class SettingsManager:
        ...
        if os.path.exists(self.settings_file):
            try:
                with open(self.settings_file, 'r') as f:
                    ...
                    self.filename_pattern = data.get('filename_pattern', self.filename_pattern)
                    self.include_metadata = data.get('include_metadata', self.include_metadata)
    ...
    def load_preset(self, name):
        ...
        if preset:
            ...
            self.filename_pattern = preset.get('filename_pattern', self.filename_pattern)
            self.include_metadata = preset.get('include_metadata', self.include_metadata)
